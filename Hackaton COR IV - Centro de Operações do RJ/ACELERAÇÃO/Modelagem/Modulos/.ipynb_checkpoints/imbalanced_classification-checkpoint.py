...
from Submodulos.cv_samplers import GroupUnderSampleSplit, print_cls_cnt
from Submodulos.imbalanced_selection import MinorityGroupSplitUndersample
...
class ClassificationPipeline:
    ...
    def binary(
        ...
        scrs = pd.DataFrame(classification_report(ye, yhat, output_dict=True)).T  # Evaluate model prediction
        if return_cls_cnt:
            return scrs, cls_cnt
        return scrs
